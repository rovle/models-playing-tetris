...
<input_structure>
Before the current board you will see one or more example board-response pairs as demonstrations of the expected output. The current board is the final image you receive; respond only to that one.
</input_structure>
